...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function carregarAtendentes() {
        ...
        fetch(apiUrl) // Não precisa de token para listar, mas precisa para agendar
            .then(response => {
            ...
            .catch(error => {
                ...
                listaAtendentesContainer.innerHTML = `<p class="error-message">Erro ao carregar atendentes. Tente novamente mais tarde.</p>`;
            });
    }
        ...
        atendentes.forEach(atendente => {
            ...
            card.innerHTML = `
                ...
                <div class="rating-container">
                    ${generateStars(atendente.media_avaliacoes)} (${(atendente.media_avaliacoes || 0).toFixed(1)})
