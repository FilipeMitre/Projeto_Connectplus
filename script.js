...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addProfileButtonListeners() {
        ...
        viewProfileButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                // Você precisará criar uma página de perfil público para o atendente
                window.location.href = `/static/atendente/perfil-publico.html?id=${professionalId}`;
            });
        });
    }
    ...
    if (viewAllButton) {
        viewAllButton.addEventListener('click', function() {
            ...
            window.location.href = '/static/atendente/buscar-atendentes.html';
        });
    }
